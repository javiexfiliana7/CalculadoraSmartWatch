    ...
    public void clickTextView(View v){
        ...
        switch(v.getId()) {
            case R.id.tv_hex:
                ...
                tv_hex.setBackgroundResource(R.color.verde);
                et_hex.setBackgroundResource(R.color.blanco);
                //desactivamos decimal
                tv_dec.setBackgroundResource(R.color.azul);
                et_dec.setBackgroundResource(R.color.gris);
                //desactivamos octal
                tv_oct.setBackgroundResource(R.color.azul);
                et_oct.setBackgroundResource(R.color.gris);
                //desactivamos binario
                tv_bin.setBackgroundResource(R.color.azul);
            ...
            case R.id.tv_dec:
                ...
                tv_hex.setBackgroundResource(R.color.azul);
            ...
            case R.id.tv_oct:
                ...
                et_hex.setBackgroundResource(R.color.gris);
                //desactivamos octal
                tv_oct.setBackgroundResource(R.color.verde);
            ...
            case R.id.tv_bin:
                ...
                et_oct.setBackgroundResource(R.color.gris);
                //desactivamos binario
                tv_bin.setBackgroundResource(R.color.verde);
